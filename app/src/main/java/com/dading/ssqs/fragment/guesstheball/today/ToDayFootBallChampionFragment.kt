...
class ToDayFootBallChampionFragment : Fragment(), OnRefreshListener, NotificationController.NotificationControllerDelegate {
    ...
    class MergeBean : Serializable {
        ...
        var bean: MutableList<ChampionBean.ChampionItems.ChampionItem>? = null
        var items: ChampionBean.ChampionItems? = null

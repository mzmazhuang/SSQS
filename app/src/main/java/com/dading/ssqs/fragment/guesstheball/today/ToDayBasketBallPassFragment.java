...
public class ToDayBasketBallPassFragment extends Fragment implements OnRefreshListener, NotificationController.NotificationControllerDelegate {

    private static final String TAG = "ToDayBasketBallPassFragment";
        ...
        for (int i = 0; i < currData.size(); i++) {
            ...
            if (items.size() != 0) {
                ...
                for (int j = 0; j < items.size(); j++) {
                    ...
                    } else if (jCbean.payTypeID == 49) {//客队得分

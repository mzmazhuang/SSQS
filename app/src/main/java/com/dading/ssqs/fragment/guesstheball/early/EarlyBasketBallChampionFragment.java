...
public class EarlyBasketBallChampionFragment extends Fragment implements OnRefreshListener, NotificationController.NotificationControllerDelegate {
    ...
    private View initView() {
        ...
        tvTitle.setText("早盘-篮球:" + LocaleController.getString(R.string.scroll_title13));

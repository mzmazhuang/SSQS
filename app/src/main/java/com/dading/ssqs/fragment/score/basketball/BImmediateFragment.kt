...
class BImmediateFragment : Fragment(), OnRefreshListener, OnLoadMoreListener, NotificationController.NotificationControllerDelegate {
    ...
    private var leagusId: String? = null
    ...
    private fun getNetDataWork(leagusId: String?, off: Int, lim: Int, isRefre: Boolean) {
        ...
        SSQSApplication.apiClient(0).getMatchBallOrTypeList(false, 2, date, "0", 0, leagusId, off, lim) { result ->

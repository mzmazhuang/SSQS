 ...
 * 更新描述   ${TODO}
 */
public class WordCupControllar {
    ...
    public WordCupControllar(Context context) {
    ...
    private void getData() {
        ...
        SSQSApplication.apiClient(0).getFiveDataList(8, mPage, 10, new CcApiClient.OnCcListener() {
            @Override

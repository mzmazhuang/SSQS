...
class ScrollBallTotalFragment : Fragment(), OnRefreshListener, NotificationController.NotificationControllerDelegate {
    ...
    class MergeBean : Serializable {
        ...
        var bean: MutableList<ScrollBallFootBallTotalBean.ScrollBallFootBallTotalItem>? = null
        var items: ScrollBallFootBallTotalBean.ScrollBallFootBallTotalItems? = null
    ...
    companion object {
        private val TAG = "ScrollBallTotalFragment"
    }
}

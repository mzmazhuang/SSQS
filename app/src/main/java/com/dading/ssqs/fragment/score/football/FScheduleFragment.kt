...
class FScheduleFragment : Fragment(), OnRefreshListener, OnLoadMoreListener, NotificationController.NotificationControllerDelegate {
    ...
    private fun setSelectTime(day: Int) {
        ...
        ScoreDataController.getInstance().clearFootBallSchedule()
    }
    ...
    private fun getNetDataWork(leagusId: String, off: Int, lim: Int, isRefre: Boolean) {
        ...
        SSQSApplication.apiClient(0).getMatchBallOrTypeList(true, 4, currTime, "0", 0, leagusId, off, lim) { result ->

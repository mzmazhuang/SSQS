...
public class FResultFragment extends Fragment implements OnRefreshListener, OnLoadMoreListener, NotificationController.NotificationControllerDelegate {

    public static final String TAG = "FResultFragment";
    ...
    private void setSelectTime(int day) {
        ...
        ScoreDataController.Companion.getInstance().clearFootBallResult();
    }
    ...
    private void getNetDataWork(String leagusId, int off, int lim, final boolean isRefre) {
        ...
        SSQSApplication.apiClient(0).getMatchBallOrTypeList(true, 3, currTime, "0", 0, leagusId, off, lim, new CcApiClient.OnCcListener() {
            @Override
            public void onResponse(CcApiResult result) {

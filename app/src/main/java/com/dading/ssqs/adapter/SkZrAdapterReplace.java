 ...
 * 更新描述   ${TODO}
 */
public class SkZrAdapterReplace extends BaseAdapter implements ListAdapter {

    private final Context                                     context;
    private final List<SKZRBean.HSubPlayersEntity> dataH;
    private final List<SKZRBean.ASubPlayersEntity> dataA;

    public SkZrAdapterReplace(Context context, List<SKZRBean.HSubPlayersEntity> hPlayers, List<SKZRBean.ASubPlayersEntity> aPlayers) {

...
import com.dading.ssqs.adapter.RedPeopleSingleHRAdapter;
 ...
 * 更新描述   ${TODO}
 */
public class RedPeopleHResult extends BaseFragnment {
    private static final String TAG = "RedPeopleHResult";
    private Timer mTimer;

    public View mRootView;
    @Bind(R.id.red_people_h_result_lv)
    ...
    private RedPeopleSingleHRAdapter mAdapter;

    @Override
    protected int setLayout() {
        return R.layout.red_people_h_result;
    }
    ...
    public void initData() {
        ...
        SSQSApplication.apiClient(0).getHotDataPage(4, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
                ...
                if (result.isOk()) {
                    ...
                    if (page != null) {
                        ...
                        if (page.getItems() != null) {
                            ...
                            if (mData.size() > 0) {
                                mAdapter = new RedPeopleSingleHRAdapter(getActivity(), mData);
                ...
                SSQSApplication.apiClient(0).getHotDataPage(4, mPage, 10, new CcApiClient.OnCcListener() {
                    ...
                    public void onResponse(CcApiResult result) {
                        ...
                        if (result.isOk()) {
                            ...
                            Logger.INSTANCE.d(TAG, result.getMessage() + "红人半场赛果失败信息");
                        }
                    }
                });
            }

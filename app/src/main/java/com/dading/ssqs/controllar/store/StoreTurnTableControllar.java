        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    LogUtil.util(TAG, "开始抽奖！改变第" + id + "图片");
                    break;
                case 199:
                    ++number;
        ...
        SSQSApplication.apiClient(0).getAwardType2(2, new CcApiClient.OnCcListener() {
            ...
            public void onResponse(CcApiResult result) {
                if (result.isOk()) {
                    ...
                    LogUtil.util(TAG, result.getMessage() + "商店转盘失败信息");
                }
            }
        });
        ...
        SSQSApplication.apiClient(0).getAwardMessageType(2, new CcApiClient.OnCcListener() {
            ...
            public void onResponse(CcApiResult result) {
                if (result.isOk()) {
                    ...
                    LogUtil.util(TAG, result.getMessage() + "转盘轮播失败信息");
                }
            }
        });
    }
    ...
    private void initListener() {
        ...
        mGv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                LogUtil.util(TAG, "开始时间------------------------------:" + mStartTime + "------------现在时间" + new Date().getTime());
                if (mData.isStart == 0) {
                            ...
                            if (result.isOk()) {
                                ...
                                if (bean != null) {
                                    ...
                                    if (mIsEnd == 0) {
                                        ...
                                        LogUtil.util(TAG, "开始抽奖！stopTime" + i);
                                    ...
                                    LogUtil.util(TAG, result.getMessage() + "抽奖结果失败信息");
                                }
                            }
                        }
                    });
    ...
    class ChangeView implements Runnable {
        ...
        public void run() {
            ...
            if (startTime >= stopTime) {
                ...
                LogUtil.util(TAG, "恭喜中奖,您获得了" + mAwards.get(mI).name + "!");
                mDialogResult.show();

...
import com.dading.ssqs.adapter.RedPeopleSingleNLAdapter;
 ...
 * 更新描述   ${TODO}
 */
public class RedPeopleNowLost extends BaseFragnment {
    private static final String TAG = "RedPeopleNowLost";

    @Bind(R.id.red_people_yp_lv)
    ...
    private RedPeopleSingleNLAdapter mAdapter;
    private Timer mTimer;

    @Override
    protected int setLayout() {
        return R.layout.red_people_yapan;
    }
    ...
    public void initData() {
        ...
        SSQSApplication.apiClient(0).getHotDataPage(2, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
                ...
                if (result.isOk()) {
                    ...
                    if (page != null) {
                        ...
                        if (page.getItems() != null) {
                            ...
                            if (mData.size() > 0) {
                                mAdapter = new RedPeopleSingleNLAdapter(getActivity(), mData);
                ...
                SSQSApplication.apiClient(0).getHotDataPage(2, mPage, 10, new CcApiClient.OnCcListener() {
                    ...
                    public void onResponse(CcApiResult result) {
                        ...
                        if (result.isOk()) {
                            ...
                            Logger.INSTANCE.d(TAG, result.getMessage() + "红人当前让球失败信息");
                        }
                    }
                });
            }

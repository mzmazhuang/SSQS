...
public class FilterDialog extends Dialog {
    ...
    private void onCreateView(LinearLayout container) {
        ...
        adapter = new FilterDialogAdapter(mContext);
        recyclerView.setAdapter(adapter);
    }

    public void setItemListener(FilterDialogAdapter.OnClickListener listener) {
        adapter.setListener(listener);
    }

    public void show(String title, String select) {
        this.show();

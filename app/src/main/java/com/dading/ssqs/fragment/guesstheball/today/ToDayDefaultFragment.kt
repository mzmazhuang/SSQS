...
class ToDayDefaultFragment : Fragment(), OnRefreshListener, NotificationController.NotificationControllerDelegate {
    ...
    class MergeBean : Serializable {
        var bean: List<ScrollBallFootBallBean.ScrollBeanItems.ScrollBeanItem>? = null
    ...
    companion object {
        private val TAG = "ToDayDefaultFragment"
    }
}

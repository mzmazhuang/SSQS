 ...
 * 更新描述   ${TODO}
 */
public class HotSpotControllar {
    ...
    public HotSpotControllar(Context context) {
    ...
    private void getData() {
        ...
        SSQSApplication.apiClient(0).getFiveDataList(2, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
            public void onResponse(CcApiResult result) {
                if (result.isOk()) {
                    ...
                    LogUtil.util(TAG, result.getMessage() + "热点失败信息");
                }
            }
        });
    }

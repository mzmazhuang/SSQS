...
public class PageDialog extends Dialog {
    ...
    private PageDialogAdapter adapter;
    ...
    private void onCreateView(LinearLayout container) {
        ...
        container.addView(bottomLayout, LayoutHelper.createLinear(LayoutHelper.MATCH_PARENT, 200));
        ...
        adapter = new PageDialogAdapter(mContext);
        recyclerView.setAdapter(adapter);
    }

    public void setItemListener(PageDialogAdapter.OnClickListener listener) {
        adapter.setListener(listener);
    }

    public void show(List<Integer> list, String title, int select) {
        this.show();

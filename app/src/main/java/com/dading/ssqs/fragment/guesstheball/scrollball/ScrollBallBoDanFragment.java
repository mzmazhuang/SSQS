...
public class ScrollBallBoDanFragment extends Fragment implements OnRefreshListener, NotificationController.NotificationControllerDelegate {

    private static final String TAG = "ScrollBallBoDanFragment";
            ...
            if (leagueMatchId == id || leagueMatchId == -1) {
                ...
                if (isAdd) {//是添加 还是删除
                    if (leagusList.size() == 0) {
                        ...
                        mergeBean.setHome(bean.getSelected() != 2);
    ...
    public static class MergeBean implements Serializable {
        ...
        private List<ScrollBallFootBallBoDanBean.ScrollBallFootBallBoDanItem> bean;
        private ScrollBallFootBallBoDanBean.ScrollBallFootBallBoDanItems items;
        ...
        public List<ScrollBallFootBallBoDanBean.ScrollBallFootBallBoDanItem> getBean() {
            return bean;
        }

        public void setBean(List<ScrollBallFootBallBoDanBean.ScrollBallFootBallBoDanItem> bean) {
            this.bean = bean;
        }

        public ScrollBallFootBallBoDanBean.ScrollBallFootBallBoDanItems getItems() {
            return items;
        }

        public void setItems(ScrollBallFootBallBoDanBean.ScrollBallFootBallBoDanItems items) {
            this.items = items;
        }
    }
}

 ...
 *******************************************************************************/
package com.dading.ssqs.components.pulltorefresh.internal;
...
import com.dading.ssqs.components.pulltorefresh.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	// add
	public final void hideHeaderImgVsProgress() {
		mHeaderProgress.setVisibility(View.INVISIBLE);
		mHeaderImage.setVisibility(View.INVISIBLE);
	}

	public final void showHeaderImgVsProgress() {

...
import com.dading.ssqs.bean.WeekDateObj;
...
public class DateUtils {
	...
	public static String formatTime(Long time, String formatType) {
		String format;
		try {
			SimpleDateFormat formater = new SimpleDateFormat(formatType, Locale.CHINA);
	...
	public static String changeFormater(String oldDateStr, String oldPattern, String newPattern) {
		...
		try {
			SimpleDateFormat oldFormater = new SimpleDateFormat(oldPattern, Locale.CHINA);
			SimpleDateFormat newFormater = new SimpleDateFormat(newPattern, Locale.CHINA);
	...
	public static String diffCurTimeS(String time, String curTime) {
		try {
			SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.CHINA);
			Date date2 = df.parse(curTime);
			Date date1 = df.parse(time);

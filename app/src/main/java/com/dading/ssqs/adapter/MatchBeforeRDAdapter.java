 ...
 */
public class MatchBeforeRDAdapter extends BaseAdapter implements ListAdapter {
    private static final String TAG = "MatchBeforeRNAdapter";
    private final Context                                                          context;
    private final List<MatchBeforBeanAll.LeagueDateEntity.MatchsEntity> data;


    public MatchBeforeRDAdapter(Context context, List<MatchBeforBeanAll.LeagueDateEntity.MatchsEntity> matchsRd) {

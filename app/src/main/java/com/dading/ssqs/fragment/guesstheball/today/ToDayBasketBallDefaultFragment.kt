...
class ToDayBasketBallDefaultFragment : Fragment(), OnRefreshListener, NotificationController.NotificationControllerDelegate {
    ...
    companion object {
        private val TAG = "ToDayBasketBallDefaultFragment"
    }
}

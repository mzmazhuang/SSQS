...
import com.dading.ssqs.adapter.newAdapter.WxAdapter
...
class ZfbFragment constructor(private val listener: BankAdapter.OnRechargeClickListener) : Fragment() {

    private var recyclerView: RecyclerView? = null
    private var adapter: WxAdapter? = null

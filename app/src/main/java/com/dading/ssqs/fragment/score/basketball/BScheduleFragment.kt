...
class BScheduleFragment : Fragment(), OnRefreshListener, OnLoadMoreListener, NotificationController.NotificationControllerDelegate {
    ...
    private fun setSelectTime(day: Int) {
        ...
        ScoreDataController.getInstance().clearBasketBallSchedule()
    }
    ...
    private fun getNetDataWork(leagusId: String, off: Int, lim: Int, isRefre: Boolean) {
        ...
        SSQSApplication.apiClient(0).getMatchBallOrTypeList(false, 4, currTime, "0", 0, leagusId, off, lim) { result ->

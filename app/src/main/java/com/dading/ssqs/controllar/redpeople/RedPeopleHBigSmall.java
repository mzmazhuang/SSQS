...
import com.dading.ssqs.adapter.RedPeopleSingleAdapterHBS;
 ...
 * 更新描述   ${TODO}
 */
public class RedPeopleHBigSmall extends BaseFragnment {
    private static final String TAG = "RedPeopleHBigSmall";
    public View mRootView;
    @Bind(R.id.red_people_h_bs_lv)
    ...
    private RedPeopleSingleAdapterHBS mAdapter;
    private Timer mTimer;

    @Override
    protected int setLayout() {
        return R.layout.red_people_bs;
    }
    ...
    public void initData() {
        ...
        SSQSApplication.apiClient(0).getHotDataPage(6, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
                ...
                if (result.isOk()) {
                    ...
                    if (page != null) {
                        ...
                        if (page.getItems() != null) {
                            ...
                            if (mData.size() > 0) {
                                mAdapter = new RedPeopleSingleAdapterHBS(getActivity(), mData);
                ...
                SSQSApplication.apiClient(0).getHotDataPage(6, mPage, 10, new CcApiClient.OnCcListener() {
                    ...
                    public void onResponse(CcApiResult result) {
                        ...
                        if (result.isOk()) {
                            ...
                            Logger.INSTANCE.d(TAG, result.getMessage() + "红人半场大小失败信息");
                        }
                    }
                });
            }

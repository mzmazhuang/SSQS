...
public class MyBettingAdapterNoFinish extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.mBettingLvItmeProfitText = (TextView) convertView.findViewById(R.id.betting_lv_itme_group_profit_text);
            convertView.setTag(holder);
        } else {
            holder = (ViewHolder) convertView.getTag();
        }
        holder.mBettingLvItmeProfit.setVisibility(View.GONE);
        holder.mBettingLvItmeProfitText.setVisibility(View.GONE);

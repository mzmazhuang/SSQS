...
class EarlyBasketBallChampionFragment : Fragment(), OnRefreshListener, NotificationController.NotificationControllerDelegate {
    ...
    private fun initView(): View {
        ...
        tvTitle.text = "早盘-篮球:" + LocaleController.getString(R.string.scroll_title13)
        ...
        container.addView(defaultView, LayoutHelper.createRelative(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT))
    ...
    private fun getNetDataWork(off: Int, lim: Int) {
        SSQSApplication.apiClient(0).getChampionList(2, sType, off, lim) { result ->
            loadingDialog!!.dismiss()

 ...
 * 更新描述   ${TODO}
 */
public class MyReferHResult extends BaseFragnment {
    ...
    public void initData() {
         ...
         * /v1.0/recomm/type/{type}/page/{page}/count/{count}
         ...
         b)	请求方式:get
         c)	请求参数说明：type：赔率类型
         1-全场赛果2- 当前让球3-半场赛果4-半场赛果5-半场让球6-半场大小
         auth_token：登陆后加入请求头
         */
        getdata();
    ...
    private void getdata() {
        ...
        SSQSApplication.apiClient(0).getRecommPage(4, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
            public void onResponse(CcApiResult result) {
                if (result.isOk()) {
                    ...
                    LogUtil.util(TAG, result.getMessage() + "我的推荐失败信息");
                }
            }
        });
    }
                ...
                SSQSApplication.apiClient(0).getRecommPage(4, mPage, 10, new CcApiClient.OnCcListener() {
                    ...
                    public void onResponse(CcApiResult result) {
                        ...
                        if (result.isOk()) {
                            ...
                            LogUtil.util(TAG, result.getMessage() + "我的推荐赛果失败信息");
                        }
                    }
                });
            }

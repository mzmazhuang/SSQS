 ...
 * 更新描述   ${TODO}
 */
public class RedPeopleSingleSBAdapter extends BaseAdapter implements ListAdapter {
    private static final String TAG = "RedPeopleSingleAdapter";
    private final Context context;
    private final List<RedPopleARBean> data;
    private int mStatus;

    public RedPeopleSingleSBAdapter(Context context, List<RedPopleARBean> list) {

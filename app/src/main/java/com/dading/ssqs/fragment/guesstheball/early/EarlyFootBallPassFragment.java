...
public class EarlyFootBallPassFragment extends Fragment implements OnRefreshListener, NotificationController.NotificationControllerDelegate {

    private static final String TAG = "EarlyFootBallPassFragment";
    ...
    private View initView() {
        ...
        tvTitle.setText("早盘-足球:" + LocaleController.getString(R.string.scroll_title14));

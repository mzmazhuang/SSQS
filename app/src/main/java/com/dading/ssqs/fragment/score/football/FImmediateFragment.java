...
public class FImmediateFragment extends Fragment implements OnRefreshListener, OnLoadMoreListener, NotificationController.NotificationControllerDelegate {

    public static final String TAG = "FImmediateFragment";
    ...
    private boolean hasInit = false;//是否有过初始化

    public boolean beginInit = false;
    ...
    private void getNetDataWork(String leagusId, int off, int lim, final boolean isRefre) {
        ...
        SSQSApplication.apiClient(0).getMatchBallOrTypeList(true, 2, date, "0", 0, leagusId, off, lim, new CcApiClient.OnCcListener() {
            @Override
            public void onResponse(CcApiResult result) {

 ...
 */
package com.dading.ssqs.components.wheelview.widget;
...
import com.dading.ssqs.components.wheelview.adapter.BaseWheelAdapter;
import com.dading.ssqs.components.wheelview.adapter.SimpleWheelAdapter;
import com.dading.ssqs.components.wheelview.common.WheelConstants;
import com.dading.ssqs.components.wheelview.common.WheelViewException;
import com.dading.ssqs.components.wheelview.graphics.DrawableFactory;
import com.dading.ssqs.components.wheelview.util.WheelUtils;
...
public class WheelView<T> extends ListView implements IWheelView<T> {
    ...
    public void join(WheelView wheelView) {
        if (wheelView == null) {
            throw new WheelViewException("com.dading.ssqs.components.wheelview cannot be null.");
        }

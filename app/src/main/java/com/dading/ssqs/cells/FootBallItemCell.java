...
public class FootBallItemCell extends LinearLayout {
    ...
    private FootBallDetailsItemAdapter adapter;

    public FootBallItemCell(Context context, final int type) {
        super(context);
        mContext = context;
        ...
        adapter = new FootBallDetailsItemAdapter(context);
    ...
    public void setFocus(List<ScrollFootBallDetailsActivity.FootData.FootItemData> focus) {
        adapter.setFocus(focus);
    }

    public void setListener(FootBallDetailsItemCell.OnItemClickListener listener) {
        adapter.setItemClickListener(listener);
    }

    public List<ScrollFootBallDetailsActivity.FootData> getItem() {
        return adapter.getData();
    }

    public void setOnItemClickListener(FootBallDetailsItemAdapter.OnItemClickListener listener) {

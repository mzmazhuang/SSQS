...
class EarlyBasketBallDefaultFragment : Fragment(), OnRefreshListener, NotificationController.NotificationControllerDelegate {
    ...
    private fun initView(): View {
        ...
        tvTitle.text = "早盘-篮球:" + LocaleController.getString(R.string.scroll_title1)
    ...
    companion object {
        private val TAG = "EarlyBasketBallDefaultFragment"
    }
}

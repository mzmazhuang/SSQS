...
class EarlyTotalFragment : Fragment(), OnRefreshListener, NotificationController.NotificationControllerDelegate {
    ...
    private fun initView(): View {
        ...
        tvTitle.text = "早盘-足球:" + LocaleController.getString(R.string.scroll_title3)
    ...
    private fun handleOtherData(items: List<JCScorebean>?, currData: List<EarlyBean.EarlyMatchs>): List<ScrollBallFootBallTotalBean.ScrollBallFootBallTotalItems> {
    ...
    companion object {
        private val TAG = "EarlyTotalFragment"
    }
}

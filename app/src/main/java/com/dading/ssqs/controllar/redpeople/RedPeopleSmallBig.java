...
import com.dading.ssqs.adapter.RedPeopleSingleSBAdapter;
 ...
 * 更新描述   ${TODO}
 */
public class RedPeopleSmallBig extends BaseFragnment {
    private static final String TAG = "RedPeopleSmallBig";
    @Bind(R.id.red_people_samll_big_lv)
    ...
    private RedPeopleSingleSBAdapter mAdapter;
    private Timer mTimer;

    @Override
    protected int setLayout() {
        return R.layout.red_people_samll_big;
    }
    ...
    public void initData() {
        ...
        SSQSApplication.apiClient(0).getHotDataPage(3, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
                ...
                if (result.isOk()) {
                    ...
                    if (page != null) {
                        ...
                        if (page.getItems() != null) {
                            ...
                            if (mData.size() > 0) {
                                mAdapter = new RedPeopleSingleSBAdapter(getActivity(), mData);
                ...
                SSQSApplication.apiClient(0).getHotDataPage(3, mPage, 10, new CcApiClient.OnCcListener() {
                    ...
                    public void onResponse(CcApiResult result) {
                        ...
                        if (result.isOk()) {
                            ...
                            Logger.INSTANCE.d(TAG, result.getMessage() + "红人全场大小失败信息");
                        }
                    }
                });
            }

...
public class EarlyBasketBallDefaultFragment extends Fragment implements OnRefreshListener, NotificationController.NotificationControllerDelegate {

    private static final String TAG = "EarlyBasketBallDefaultFragment";
    ...
    private View initView() {
        ...
        tvTitle.setText("早盘-篮球:" + LocaleController.getString(R.string.scroll_title1));

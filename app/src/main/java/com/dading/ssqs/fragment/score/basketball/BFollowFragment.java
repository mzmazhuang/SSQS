...
public class BFollowFragment extends Fragment implements OnRefreshListener, OnLoadMoreListener {

    public static final String TAG = "BFollowFragment";
    ...
    private void getNetDataWork(int off, int lim, final boolean isRefre) {
        SSQSApplication.apiClient(0).getMatchBallOrTypeList(false, 5, "2016082200:00:00", "0", 0, "0", off, lim, new CcApiClient.OnCcListener() {
            @Override
            public void onResponse(CcApiResult result) {

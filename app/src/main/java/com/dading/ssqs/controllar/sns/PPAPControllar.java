...
public class PPAPControllar {
    ...
    public PPAPControllar(Context context) {
    ...
    private void getData() {
        ...
        SSQSApplication.apiClient(0).getFiveDataList(5, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
            public void onResponse(CcApiResult result) {
                if (result.isOk()) {
                    ...
                    LogUtil.util(TAG, result.getMessage() + "中超失败信息");
                }
            }
        });
    }

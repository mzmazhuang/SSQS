 ...
 * 更新描述   ${TODO}
 */
public class ReferInfoHBigSmall {
    ...
    public ReferInfoHBigSmall(Context context, String savantID) {
    ...
    private View initView() {
        View view = View.inflate(context, R.layout.red_people_bs, null);
        mLv = ButterKnife.findById(view, R.id.red_people_h_bs_lv);
    ...
    private void initData() {
        ...
        SSQSApplication.apiClient(0).getRecommExpert(6, savantID, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
                ...
                SSQSApplication.apiClient(0).getRecommExpert(6, savantID, mPage, 10, new CcApiClient.OnCcListener() {
                    ...
                    public void onResponse(CcApiResult result) {
                        ...
                        if (result.isOk()) {
                            ...
                            Logger.INSTANCE.d(TAG, result.getMessage() + "专家推荐列表半场大小失败信息");
                        }
                    }
                });
            }

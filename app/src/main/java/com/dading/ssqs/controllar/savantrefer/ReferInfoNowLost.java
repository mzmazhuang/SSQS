...
public class ReferInfoNowLost {
    ...
    public ReferInfoNowLost(Context context, String savantID) {
    ...
    private View initView() {
        View view = View.inflate(context, R.layout.red_people_yapan, null);
        mLv = ButterKnife.findById(view, R.id.red_people_yp_lv);
    ...
    private void initData() {
        ...
        SSQSApplication.apiClient(0).getRecommExpert(2, savantID, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
                ...
                SSQSApplication.apiClient(0).getRecommExpert(2, savantID, mPage, 10, new CcApiClient.OnCcListener() {
                    ...
                    public void onResponse(CcApiResult result) {
                        ...
                        if (result.isOk()) {
                            ...
                            LogUtil.util(TAG, result.getMessage() + "专家推荐列表当前让球失败信息");
                        }
                    }
                });
            }

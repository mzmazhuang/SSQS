 ...
 * 更新描述   ${TODO}
 */
public class MyFollowListAdapter extends BaseAdapter implements ListAdapter {
    ...
    public MyFollowListAdapter(Context context, List<MyFollowBean> data, int i) {
            ...
            holder.mMyFollowFollowTag.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    SSQSApplication.apiClient(0).focusUser(element, new CcApiClient.OnCcListener() {
                        ...
                        public void onResponse(CcApiResult result) {
                            if (result.isOk()) {
                                UIUtils.SendReRecevice(Constent.MY_FANS_TAG);

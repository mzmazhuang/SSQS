 ...
 * 更新描述   ${TODO}
 */
public class ReferInfoAllResult {
    ...
    public ReferInfoAllResult(Context context, String id) {
    ...
    private View initView() {
        View view = View.inflate(context, R.layout.red_people_single, null);
        mLv = ButterKnife.findById(view, R.id.red_people_lv);
    ...
    private void initData() {
        /**
         6.	专家推荐列表
         a)	请求地址：/v1.0/recomm/type/{type}/userID/{userID}/page/{page}/count/{count}
         b)	请求方式:get
         c)	请求参数说明：type：赔率类型
         1-全场赛果2- 当前让球3-全场大小4-半场赛果5-半场让球6-半场大小
         userID:用户ID    auth_token：登陆后加入请求头
         */
        mPage = 1;

        SSQSApplication.apiClient(0).getRecommExpert(1, savantID, mPage, 10, new CcApiClient.OnCcListener() {
            @Override

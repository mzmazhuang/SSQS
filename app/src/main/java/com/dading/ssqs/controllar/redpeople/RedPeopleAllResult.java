...
import com.dading.ssqs.adapter.RedPeopleSingleAdapter;
 ...
 * 更新描述   ${TODO}
 */
public class RedPeopleAllResult extends BaseFragnment {
    private static final String TAG = "RedPeopleAllResult";
    public View mRootView;
    @Bind(R.id.red_people_lv)
    ...
    private int mPage;
    private RedPeopleSingleAdapter mAdapter;
    private int mTotalPage;
    private Timer mTimer;

    @Override
    protected int setLayout() {
        return R.layout.red_people_single;
    }
    ...
    public void initData() {
        ...
        SSQSApplication.apiClient(0).getHotDataPage(1, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
                    ...
                    if (page != null) {
                        ...
                        if (page.getItems() != null) {
                            ...
                            if (mData.size() > 0) {
                                ...
                                mAdapter = new RedPeopleSingleAdapter(getActivity(), mData);

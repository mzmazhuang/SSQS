...
public class FootDetailsChildCell extends LinearLayout {
    ...
    private ScrollFootBallDetailsActivity.FootData.FootItemData data;
    private ScrollFootBallDetailsActivity.FootData footData;

    public FootDetailsChildCell(Context context) {
        super(context);
        ...
        addView(title, LayoutHelper.createLinear(0, LayoutHelper.MATCH_PARENT, 1f));
    ...
    public void changeParams() {
        ...
        LayoutParams numberLP = (LayoutParams) numberView.getLayoutParams();
        numberLP.weight = 1;
    ...
    public void setListener(final FootBallDetailsItemCell.OnItemClickListener listener) {
        setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (listener != null) {
                    if (check) {
                        if (listener.onClick(data, footData, false)) {
                            check = false;
                        ...
                        if (listener.onClick(data, footData, true)) {
                            check = true;
    ...
    public void setData(ScrollFootBallDetailsActivity.FootData.FootItemData data, ScrollFootBallDetailsActivity.FootData basketData, List<ScrollFootBallDetailsActivity.FootData.FootItemData> focus, int position, boolean isCheck) {
        this.data = data;
        this.footData = basketData;
        ...
        if (focus != null) {
            for (int i = 0; i < focus.size(); i++) {
                ScrollFootBallDetailsActivity.FootData.FootItemData bean = focus.get(i);

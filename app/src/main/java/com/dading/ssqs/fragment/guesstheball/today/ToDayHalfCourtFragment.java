...
public class ToDayHalfCourtFragment extends Fragment implements OnRefreshListener, NotificationController.NotificationControllerDelegate {

    private static final String TAG = "ToDayHalfCourtFragment";
        ...
        filterCell.setSelectClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (DataController.Companion.getInstance().getTodayFootBallData() == null) {
                    DataController.Companion.getInstance().syncFootBall(TAG, 2);
                    loadingDialog.show();
                } else {

 ...
 * 更新描述   ${TODO}
 */
public class FootBallLotteryControllar {
    ...
    public FootBallLotteryControllar(Context context) {
    ...
    private void getData() {
        ...
        SSQSApplication.apiClient(0).getFiveDataList(4, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
            public void onResponse(CcApiResult result) {
                if (result.isOk()) {
                    ...
                    Logger.INSTANCE.d(TAG, result.getMessage() + "足彩失败信息");
                }
            }
        });
    }

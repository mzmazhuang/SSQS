 ...
 * 更新描述   ${TODO}
 */
public class RedPeopleSingleAdapter extends BaseAdapter implements ListAdapter {
    private static final String TAG = "RedPeopleSingleAdapter";
    private final Context context;
    private final List<RedPopleARBean> data;
    private int mStatus;

    public RedPeopleSingleAdapter(Context context, List<RedPopleARBean> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (entity != null) {
            ...
            hoder.mRedPeopleArItemNumber.setText(String.valueOf(position + 1));

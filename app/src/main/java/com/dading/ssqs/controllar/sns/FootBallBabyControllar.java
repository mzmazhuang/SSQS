 ...
 * 更新描述   ${TODO}
 */
public class FootBallBabyControllar {
    ...
    private int mPage;
    public FootBallBabyAdapter mAdapter;

    private int totalCount;

    public FootBallBabyControllar(Context context) {
    ...
    private View initView() {
        ...
        mAdapter = new FootBallBabyAdapter(context);
    ...
    private void getData() {
        ...
        SSQSApplication.apiClient(0).getFiveDataList(6, mPage, 10, new CcApiClient.OnCcListener() {
            @Override
            public void onResponse(CcApiResult result) {
                if (result.isOk()) {
                    ...
                    LogUtil.util(TAG, result.getMessage() + "足球宝贝失败信息");
                }
            }
        });
    }

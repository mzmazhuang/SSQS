...
public class ValueAnimator extends Animator10 {
    ...
    static final ThreadLocal<AnimationHandler> sAnimationHandler = new ThreadLocal<>();
    ...
    static class AnimationHandler implements Runnable {

        final ArrayList<ValueAnimator> mAnimations = new ArrayList<>();
        private final ArrayList<ValueAnimator> mTmpAnimations = new ArrayList<>();
        final ArrayList<ValueAnimator> mPendingAnimations = new ArrayList<>();
        final ArrayList<ValueAnimator> mDelayedAnims = new ArrayList<>();
    ...
    private boolean doAnimationFrame(long frameTime) {

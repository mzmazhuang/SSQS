 ...
 * 更新描述   ${TODO}
 */
public class RedPeopleSingleNLAdapter extends BaseAdapter implements ListAdapter {
    private static final String TAG = "RedPeopleSingleAdapter";
    private final Context context;
    private final List<RedPopleARBean> data;
    private int mStatus;

    public RedPeopleSingleNLAdapter(Context context, List<RedPopleARBean> list) {

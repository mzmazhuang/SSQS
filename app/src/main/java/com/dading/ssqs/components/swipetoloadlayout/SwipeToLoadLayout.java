...
public class SwipeToLoadLayout extends ViewGroup {
     ...
     * @param style
     */
    private void setSwipeStyle(int style) {
        this.mStyle = style;
        requestLayout();
    }
     ...
     */
    private void setDragRatio(float dragRatio) {
     ...
     * @param offset
     */
    private void setRefreshTriggerOffset(int offset) {
     ...
     * @param offset
     */
    private void setLoadMoreTriggerOffset(int offset) {
     ...
     * @param offset
     */
    private void setRefreshFinalDragOffset(int offset) {
     ...
     * @param offset
     */
    private void setLoadMoreFinalDragOffset(int offset) {
     ...
     * @param duration
     */
    private void setSwipingToRefreshToDefaultScrollingDuration(int duration) {
     ...
     * @param duration
     */
    private void setReleaseToRefreshingScrollingDuration(int duration) {
     ...
     * @param duration
     */
    private void setRefreshCompleteDelayDuration(int duration) {
     ...
     * @param duration
     */
    private void setRefreshCompleteToDefaultScrollingDuration(int duration) {
     ...
     * @param duration
     */
    private void setDefaultToRefreshingScrollingDuration(int duration) {
     ...
     * @param duration
     */
    private void setSwipingToLoadMoreToDefaultScrollingDuration(int duration) {
     ...
     * @param duration
     */
    private void setReleaseToLoadingMoreScrollingDuration(int duration) {
     ...
     * @param duration
     */
    private void setLoadMoreCompleteDelayDuration(int duration) {
     ...
     * @param duration
     */
    private void setLoadMoreCompleteToDefaultScrollingDuration(int duration) {
     ...
     * @param duration
     */
    private void setDefaultToLoadingMoreScrollingDuration(int duration) {
    ...
    private final LoadMoreCallback mLoadMoreCallback = new LoadMoreCallback() {

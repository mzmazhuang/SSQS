...
public class EarlyChampionFragment extends Fragment implements OnRefreshListener, NotificationController.NotificationControllerDelegate {
    ...
    private View initView() {
        ...
        tvTitle.setText("早盘-足球:" + LocaleController.getString(R.string.scroll_title13));

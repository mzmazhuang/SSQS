...
public class ToDayTotalFragment extends Fragment implements OnRefreshListener, NotificationController.NotificationControllerDelegate {

    private static final String TAG = "ToDayTotalFragment";
                    ...
                    public void onResponse(CcApiResult result) {
                        if (result.isOk()) {
                            ...
                            if (items != null && items.size() >= 1) {
                                ...
                                ToastUtils.midToast(mContext, "总入球 暂无数据!!", 0);
                            }
                        } else {

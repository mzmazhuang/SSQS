...
public class ToDayFootBallChampionFragment extends Fragment implements OnRefreshListener, NotificationController.NotificationControllerDelegate {
    ...
    private void getNetDataWork(final int off, int lim) {
        SSQSApplication.apiClient(0).getChampionList(1, sType, off, lim, new CcApiClient.OnCcListener() {
            @Override
            public void onResponse(CcApiResult result) {
                loadingDialog.dismiss();
    ...
    public static class MergeBean implements Serializable {
        ...
        private List<ChampionBean.ChampionItems.ChampionItem> bean;
        ...
        public List<ChampionBean.ChampionItems.ChampionItem> getBean() {
            return bean;
        }

        public void setBean(List<ChampionBean.ChampionItems.ChampionItem> bean) {
            this.bean = bean;
        }

        public ChampionBean.ChampionItems getItems() {
            return items;
        }

        public void setItems(ChampionBean.ChampionItems items) {
            this.items = items;
        }
    }
}

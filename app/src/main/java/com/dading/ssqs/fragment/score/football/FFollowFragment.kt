...
class FFollowFragment : Fragment(), OnRefreshListener, OnLoadMoreListener {
    ...
    private fun getNetDataWork(off: Int, lim: Int, isRefre: Boolean) {
        SSQSApplication.apiClient(0).getMatchBallOrTypeList(true, 5, "2016082200:00:00", "0", 0, "0", off, lim) { result ->
